...
>(({ className, ...props }, ref) => (
  <SliderPrimitive.Root
    ...
    {...props}
  >
    <SliderPrimitive.Track className="relative h-2 w-full grow overflow-hidden rounded-full bg-[#d1156f29]">
      <SliderPrimitive.Range className="absolute h-full bg-[#d1156f]" />
